  ...
  #abstract(
    ...
    当今正处于体系结构的新黄金年代，RISC-V指令集架构的诞生和现代电子设计自动化（Electronic design automation，EDA）工具的进步重新定义了处理器设计的方法论，使得敏捷开发成为可能。由于在学术界，工业界，社区以及其他相关工作多关注高性能计算处理器，闭源商业处理器，以及现场可编程门阵列（Field Programmable Gate Array，FPGA）流程处理器的设计与验证，缺少特定应用集成电路（Application-Specific Integrated Circuit，ASIC）流程嵌入式处理器的设计，验证以及相关的量化研究思路整合。
