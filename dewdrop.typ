    ...
    block(
      ...
      inset: 3em,
      {
        block(
          ...
          width: 100%,
          radius: 0.2em,
          text(size: 1.4em, fill: self.colors.primary, text(weight: "medium", info.title)) + (
  ...
  touying-slide(
    ...
    components.adaptive-columns(
      ...
      text(
        ...
        outline(title: none, indent: 2em, depth: self.slide-level, ..args),
      ),
    ),
  )
})
...
#let dewdrop-theme(
  ...
  footer: none,
  footer-right: "Pages: " + context utils.slide-counter.display() + " / " + utils.last-slide-number,
  primary: rgb("#0c4842"),
  alpha: 60%,
